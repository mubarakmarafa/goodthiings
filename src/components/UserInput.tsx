          ...
          {isDropdownOpen ? (
            ...
            <div className="flex flex-row items-center justify-start h-full">
              ...
              <div className="pr-[5px]">
                <button className="w-[60px] h-[60px] bg-[#6AADFF] rounded-[20px] flex items-center justify-center hover:bg-[#5A9AEF] transition-colors outline-none focus:outline-none">
